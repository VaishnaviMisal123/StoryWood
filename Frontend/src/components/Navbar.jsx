  ...
  useEffect(() => {
    ...
    const navItems = (
        <>
            ...
            <li><a href='/course' className='hover:text-pink-500'>Course</a></li>
...
{authUser ? (<Logout />) : (
  <div className="">
    <a className="bg-black text-white px-3 py-2 rounded-md hover:bg-pink-500  duration-300 cursor-pointer" onClick={() => document.getElementById("my_modal_3").showModal()}>Login</a>
    <Login />
  </div>
)}
</div>
